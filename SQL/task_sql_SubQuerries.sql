...
Таблица - user						
id	 user_name	level_id	skill			Таблица - level	
1	 Anton		1		900000	               id	level_name
2	 Denis		3		4000	                1	admin
3	 Petr		2		50000			2	power_user
4	 Andrey		4		20			3	user
5	 Olga		1		600000			4	guest
6	 Anna		1		1600000			
...
FROM user
LEFT JOIN level ON level.id=user.level_id
